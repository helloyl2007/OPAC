...
课时计划与要求：
{plan_details}
请为{subject_scope}{topic}生成一份完整教案：包含所有必要的教学环节。根据课时数{lesson_count}合理安排教学过程。
...
<table>
    ...
    <tr>
        <td>教材分析</td>
        <td colspan="2">（教材分析内容）</td>
    </tr>
    <tr>
        <td>学情分析</td>
        <td colspan="2">（学情分析内容）</td>
    </tr>
    <tr>
        <td>课时数</td>
    ...
    <tr>
        <td>作业布置</td>
        <td colspan="2"><pre>（按实际内容，可布置如：基础作业、提升作业、实践作业等）</pre></td>
    </tr>    
    <tr>
        <td>板书设计</td>
